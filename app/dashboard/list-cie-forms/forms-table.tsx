  ...
  const filteredAndSortedForms = useMemo(() => {
    const filtered = forms.filter((form) => {
      ...
      const matchesDepartment =
        ...
        form.subjects?.departments?.id === departmentFilter;
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="min-w-[120px] text-lg">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {filteredAndSortedForms.length === 0 ? (
              ...
              filteredAndSortedForms.map((form) => (
                <TableRow key={form.id}>
                  <TableCell className="text-base font-medium pl-5">
                    {form.users?.name || "Unknown Faculty"}
                  </TableCell>
                  <TableCell>
                    <div>
                      <div className="text-base font-medium pl-3">
                        {form.subjects?.name || "Unknown Subject"}
                      </div>
                    </div>
                  </TableCell>
                  <TableCell>
                    <div>
                      <div className="text-base font-medium pl-5">
