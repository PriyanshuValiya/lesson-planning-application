...
export default function ViewActualCie({
  ...
  const formatUnitNumber = (unitNum: string) => {
    const num = parseInt(unitNum.trim());
    return num > 0 ? `${num}` : "-";
  };
              ...
              <TableFooter>
                <TableRow>
                  ...
                  >
                    ...
                    >
                      Quality <p className="text-xs">Review Date</p>
                    </p>
                    <div className="mt-1">
                      {actual.quality_review_date ? (
                        format(
                          parseISO(actual.quality_review_date),
                          "dd-MM-yyyy"
                        )
                      ) : (
                  ...
                  >
                    <p
                      className={`flex flex-col whitespace-normal mx-auto text-sm leading-tight`}
                    >
                      <p>View</p>
                      <button
                        className="underline cursor-pointer"
