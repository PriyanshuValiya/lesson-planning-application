...
export default function FacultyDashboard() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="p-8">
        <h2 className="text-3xl font-bold text-[#1A5CA1] mb-2">Welcome {userData.name}</h2>
        <p className="text-xl text-gray-700 mb-1">Faculty, {currentRole?.departments?.name || "Department"}</p>
