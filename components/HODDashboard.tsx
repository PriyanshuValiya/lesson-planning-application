...
// // //         const departSubjects = data.filter((subject) => subject.department_id === currentRole.depart_id)
...
// // //   if (!currentRole || currentRole.role_name !== "HOD") {
// // //     return (
// // //       <div className="p-8">
...
// // //                 <h3 className="font-manrope font-semibold text-[17px] leading-[100%] tracking-[0em]">Total Faculty</h3>
...
// // //             <div className="flex items-center justify-between px-5 border rounded-lg border-black h-20">
// // //               <div className="flex flex-col justify-between h-14">
// // //                 <h3 className="font-manrope font-semibold text-[16px] leading-[100%] tracking-[0em]">Total Subjects</h3>
// // //                 <p className="font-manrope font-bold text-[30px] leading-[100%] tracking-[0em] text-[#1A5CA1]">
// // //                   {subjects.length}
// // //                 </p>
// // //               </div>
...
// // //                     {faculty.map((ele) => (
// // //                       <TableRow key={ele.id}>
// // //                         <TableCell className="font-medium">{ele.users.name}</TableCell>
...
// // //             </div>
// // //             <div className="border rounded-lg border-black p-3">
// // //               <h2 className="font-manrope font-semibold text-[18px] leading-[100%] tracking-[0] mb-3">
// // //                 Subject Management
// // //               </h2>
...
// //     if (currentRole && currentRole.depart_id) {
// //       getFacultyData()
// //       getSubjectData()
// //     }
// //   }, [currentRole, currentRole.depart_id])
...
//                               {facultyMember.users.name}
//                             </TableCell>
//                             <TableCell>{facultyMember.users.email}</TableCell>
//                             <TableCell>
