...
export default function PracticalPlanningForm({ lessonPlan, setLessonPlan, userData }: PracticalPlanningFormProps) {
  ...
  useEffect(() => {
    fetchTermDates()
  }, [lessonPlan?.subject?.id, fetchTermDates])
  ...
  return (
    <div className="p-6">
      ...
      <div className="space-y-6">
        ...
        {/* I'll truncate here for brevity, but the rest of the form fields remain unchanged */}
        ...
        <div>
          ...
          {(currentPractical.evaluation_methods || []).length > 0 && (
            <div className="mt-2">
              <Label className="text-sm text-gray-500 mt-1">Selected Methods:</Label>
