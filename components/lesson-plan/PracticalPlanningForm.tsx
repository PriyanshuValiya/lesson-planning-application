...
//   // Add mapping functions for CO, PSO, PEO with dropdown approach
...
//                     {(watch(`practicals.${activePractical}.co_mapping`) || []).map((co: string) => (
//                       <Badge key={co} variant="secondary" className="text-xs">
//                         {co}
//                         <button
//                           type="button"
//                           onClick={() => removeCOMapping(activePractical, co)}
...
//                   {/* Selected PSOs */}
//                   <div className="mt-2 flex flex-wrap gap-2">
//                     {(watch(`practicals.${activePractical}.pso_mapping`) || []).map((pso: string) => (
//                       <Badge key={pso} variant="secondary" className="text-xs">
//                         {pso}
//                         <button
//                           type="button"
//                           onClick={() => removePSOMapping(activePractical, pso)}
//                           className="ml-1 text-red-500 hover:text-red-700"
//                         >
//                           ×
//                         </button>
...
//                   {/* Selected PEOs */}
//                   <div className="mt-2 flex flex-wrap gap-2">
//                     {(watch(`practicals.${activePractical}.peo_mapping`) || []).map((peo: string) => (
//                       <Badge key={peo} variant="secondary" className="text-xs">
//                         {peo}
//                         <button
//                           type="button"
//                           onClick={() => removePEOMapping(activePractical, peo)}
//                           className="ml-1 text-red-500 hover:text-red-700"
//                         >
//                           ×
//                         </button>
