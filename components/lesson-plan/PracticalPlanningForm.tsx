...
//     if (!currentPractical.associated_units || currentPractical.associated_units.length === 0) {
...
//                     <button
//                       onClick={() => {
//                         const updated = (currentPractical.associated_units || []).filter((id: string) => id !== unitId)
