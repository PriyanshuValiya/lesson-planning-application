...
// import { unitPlanningSchema, type UnitPlanningFormValues, skillMappingOptions } from "@/utils/schema"
...
//                 Teaching Pedagogy <span className="text-red-500">*</span> (Select at least 2 alternative pedagogies)
//               </Label>

//               {/* Traditional Pedagogy */}
//               <div className="mt-3">
//                 <Label className="text-sm font-medium text-gray-700 mb-2 block">Traditional Pedagogy (1-2)</Label>
//                 <Select
//                   value=""
//                   onValueChange={(value) => {
//                     const current = watch(`units.${activeUnit}.teaching_pedagogy`) || []
//                     if (!current.includes(value)) {
//                       handlePedagogyChange(activeUnit, value, true)
//                     }
//                   }}
//                 >
...
//                     <SelectItem value="ICT based learning">ICT based learning</SelectItem>
//                   </SelectContent>
//                 </Select>
//               </div>
...
//                   Alternative Pedagogy (3-15) - Select at least 2
//                 </Label>
//                 <Select
//                   value=""
//                   onValueChange={(value) => {
...
//                   </SelectTrigger>
//                   <SelectContent>
//                     <SelectItem value="Active Learning">Active Learning</SelectItem>
//                     <SelectItem value="Blended Learning">Blended Learning</SelectItem>
//                     <SelectItem value="Concept/Mind Mapping">Concept/Mind Mapping</SelectItem>
//                     <SelectItem value="Demonstration/Simulation-Based Learning">
...
//                     <SelectItem value="Reflective Learning">Reflective Learning</SelectItem>
//                     <SelectItem value="Role Play">Role Play</SelectItem>
//                     <SelectItem value="Storytelling/Narrative Pedagogy">Storytelling/Narrative Pedagogy</SelectItem>
//                   </SelectContent>
//                 </Select>
//               </div>
...
//               {/* Other Pedagogy */}
//               <div className="mt-3">
//                 <Label className="text-sm font-medium text-gray-700 mb-2 block">Other Pedagogy</Label>
...
//                         handlePedagogyChange(activeUnit, `Other: ${otherValue}`, true)
//                       }
//                     }}
//                   >
//                     Add
...
//                       <button
//                         type="button"
//                         onClick={() => handlePedagogyChange(activeUnit, pedagogy, false)}
